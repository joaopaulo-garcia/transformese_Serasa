...
public class CorrecaoAtividade4 {
	...
	public static void main(String[] args) {
		/*
		 * // Tipo Nome Valor int caneta = 2; String nome = "Tati"; double salario =
		 * 250.25; boolean usaOculos = true; Scanner entrada = new Scanner(System.in);
		 * 
		 * entrada.nextInt();
		 * 
		 * // Superman Nazare = new Superman(); // Nazare.voar();
		 * 
		 * 
		 * Exemplo tabela Verdade
		 * 
		 * // Tabela do E && SOL DINHEIRO PADARIA VERD VERD VERD FALSO VERD FALSO VERD
		 * FALSO FALSO FALSO FALSO FALSO
		 * 
		 * // Tabela do OU ||
		 * 
		 * Bici azul Bici Vermelha Padaria VERD VERD VERD FALSO VERD VERD VERD FALSO
		 * VERD FALSO FALSO FALSO
		 * 
		 * // Tabela no Java
		 * 
		 * true false
